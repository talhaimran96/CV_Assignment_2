...
senet = senet_model(pretrained=pretrained).to(device)
...
optimizer = torch.optim.Adam(senet.parameters(), lr=learning_rate)
...
if run_training:
    ...
    if resume_training:
        ...
        senet.load_state_dict(checkpoint["model"])
    ...
    for epoch in range(starting_epoch, epochs):
        ...
        with torch.no_grad():
            val_loss, classification_loss, arousal_loss, valence_loss, val_accuracy = run_epoch(senet,
                                                                                                classification_loss_function,
                                                                                                regression_loss_function,
                                                                                                optimizer,
                                                                                                validation_loader,
