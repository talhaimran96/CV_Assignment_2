...
mobilenet = mobilenet_model(pretrained=pretrained).to(device)
...
if run_training:
    ...
    for epoch in range(starting_epoch, epochs):
        ...
        train_loss, classification_loss, arousal_loss, valence_loss, train_accuracy = run_epoch(mobilenet,
        ...
        with torch.no_grad():
            val_loss, classification_loss, arousal_loss, valence_loss, val_accuracy = run_epoch(mobilenet,
                                                                                                classification_loss_function,
                                                                                                regression_loss_function,
                                                                                                optimizer,
                                                                                                validation_loader,
