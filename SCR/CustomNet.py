...
import wandb
import pandas as pd
from CustomModel import Talha_net
...
if run_training:
    ...
    if resume_training:
        ...
        T_net.load_state_dict(checkpoint["model"])
    ...
    for epoch in range(starting_epoch, epochs):
        ...
        train_loss, classification_loss, arousal_loss, valence_loss, train_accuracy = run_epoch(T_net,
        ...
        with torch.no_grad():
            val_loss, classification_loss, arousal_loss, valence_loss, val_accuracy = run_epoch(T_net,
                                                                                                classification_loss_function,
                                                                                                regression_loss_function,
                                                                                                optimizer,
                                                                                                validation_loader,
...
if run_test_set:
    ...
    predicted_classifications, predicted_arousal, predicted_valence, groundtruth_classification, groundtruth_arousal, groundtruth_valence = run_test(
        T_net, example_dataloader, device)
